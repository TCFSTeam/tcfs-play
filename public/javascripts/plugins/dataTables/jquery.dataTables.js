...
(/** @lends <global> */function( $ ) {
	 ...
	 *    Hungarian value in the `userSettings` object will be overwritten. Otherwise they
	 *    won't be.
	 *  @memberof DataTable#oApi
	 */
	...
	function _fnAddColumn( oSettings, nTh )
	{
		...
		else
		{
			...
			/* Don't require that the userSettings must specify bRegex, bSmart or bCaseInsensitive */
	...
	function _fnCreateTr ( oSettings, iRow, nTrIn, anTds )
	{
		...
		if ( row.nTr === null )
		{
			...
			for ( i=0, iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
				...
				/* Add userSettings defined class */
				if ( oCol.sClass !== null )
				{
	...
	function _fnBuildHead( oSettings )
	{
		...
		// row in the footer. If there is more than one row the userSettings wants to
	...
	function _fnAddOptionsHtml ( oSettings )
	{
		...
		/* Loop over the userSettings set positioning and place the elements as needed */
	...
	/**
	 * Filter the data table based on userSettings input and draw the table
	 *  @param {object} settings dataTables settings object
	...
	/**
	 * Generate the node required for userSettings display length changing
	 *  @param {object} settings dataTables settings object
	...
	function _fnScrollDraw ( settings )
	{
		...
		if ( table.outerWidth() < sanityWidth )
		{
			...
			// And give the userSettings a warning that we've stopped the table getting too small
	...
	function _fnCalculateColumnWidths ( oSettings )
	{
		...
		/* Convert any userSettings input sizes into pixel sizes */
		...
		else
		{
			...
			// data, assign any userSettings defined widths, then insert it into the DOM and
			...
			// the table width should be by summing the userSettings given values, and the
			// automatic values
			if ( scrollX )
			{
				var total = 0;
	...
	/**
	 * Function to run on userSettings sort request
	 *  @param {object} settings dataTables settings object
	...
	function _fnSortListener ( settings, colIdx, append, callback )
	{
		...
		// callback used for async userSettings interaction
	 ...
	 *  @param {object} settings dataTables settings object
	 *  @param {int} level log error messages, or display them to the userSettings
	...
	DataTable.defaults = {
		 ...
		 * cannot be overridden by userSettings interaction with the table. What this means
		 * is that you could have a column (visible or hidden) which the sorting
		 * will always be forced on first - any sorting after that (from the userSettings)
		 ...
		 * that it allows the end userSettings to input multiple words (space separated) and
		...
		/**
		 * Allows the end userSettings to select the size of a formatted page from a select
		 ...
		 * same time (activated by shift-click by the userSettings).
		 *  @type boolean
		 *  @default true
		 *
		 *  @dtopt Options
		 ...
		 * display length, filtering and sorting. As such when the end userSettings reloads
		 ...
		 * rendered as "1,000,000") to help readability for the end userSettings. This
		 ...
		 * feature enabled (`lengthChange`) then the end userSettings will be able to override
		...
		/**
		 * All strings that DataTables uses in the userSettings interface that it creates
		...
		"oLanguage": {
			...
			"oPaginate": {
				 ...
				 * button to take the userSettings to the first page.
				 *  @type string
				 *  @default First
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use when using the 'full_numbers' type of pagination for the
				 * button to take the userSettings to the last page.
				 *  @type string
				 *  @default Last
				 *
				 *  @dtopt Language
				...
				/**
				 * Text to use for the 'next' pagination button (to take the userSettings to the
				 * next page).
				 *  @type string
				 *  @default Next
				 *
				...
				/**
				 * Text to use for the 'previous' pagination button (to take the userSettings to
				 * the previous page).
				 *  @type string
				 *  @default Previous
				 *
			...
			/**
			 * This string gives information to the end userSettings about the information
			...
			/**
			 * When a userSettings filters the information in a table, this string is appended
			 ...
			 * indicate to the end userSettings the the data is being loaded. Note that this
			...
			/**
			 * Text which is displayed when the table is processing a userSettings action
			...
			/**
			 * Details the actions that will be taken when the userSettings types into the
	...
	DataTable.defaults.column = {
		 ...
		 *    // (which has both forms) is used for filtering for if a userSettings inputs either format, while
		 ...
		 * version) prior to ordering. This allows ordering to occur on userSettings
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Present a userSettings control allowing the end userSettings to change the page size
			 ...
			 * userSettings request - typically an Ajax request for server-side processing.
			 * Note that this parameter will be set by the initialisation routine. To
			 * set a default use {@link DataTable.defaults}.
			 *  @type boolean
			 */
		...
		/**
		 * List of options that can be used for the userSettings selectable length menu.
		 * Note that this parameter will be set by the initialisation routine. To
		 * set a default use {@link DataTable.defaults}.
		 *  @type array
		 *  @default []
	...
	DataTable.ext = _ext = {
		 ...
		 *    // from the end-userSettings, matching the data in a certain range.
	 ...
	 * the end userSettings that there is something happening, or that something has
	 * finished.
